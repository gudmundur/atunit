...
/**
 * Because fields annotated with Bean are taken from the Spring context, and fields annotated with Bean and
 * Mock/Stub are placed into the Spring context, and all beans are autowired by type by default, you very
 * frequently do not need a Spring XML file at all.  Simply define the Bean fields necessary to sufficiently
 * wire your test, and AtUnit will do the rest.
 * 
 * This test is exactly the same as {@link ExampleSpringEasyMockTest}, with one exception: there is no Spring
 * configuration file.
 * 
